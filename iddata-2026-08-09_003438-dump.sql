...
\restrict B3u93atvegpSZTIOkm1FTtTlMC2VztsWG2qpmkJRvwKLNx4bC51GrTdIqX26crY
...
--
-- Name: messagerole; Type: TYPE; Schema: public; Owner: zhouch
--
...
ALTER TYPE public.messagerole OWNER TO zhouch;

--
-- Name: messagestatus; Type: TYPE; Schema: public; Owner: zhouch
--
...
ALTER TYPE public.messagestatus OWNER TO zhouch;

--
-- Name: messagetype; Type: TYPE; Schema: public; Owner: zhouch
--
...
ALTER TYPE public.messagetype OWNER TO zhouch;

--
-- Name: sessionstatus; Type: TYPE; Schema: public; Owner: zhouch
--
...
ALTER TYPE public.sessionstatus OWNER TO zhouch;

--
-- Name: chinese_zh; Type: TEXT SEARCH CONFIGURATION; Schema: public; Owner: zhouch
--
...
ALTER TEXT SEARCH CONFIGURATION public.chinese_zh OWNER TO zhouch;

--
-- Name: zhparser_zh; Type: TEXT SEARCH CONFIGURATION; Schema: public; Owner: zhouch
--

CREATE TEXT SEARCH CONFIGURATION public.zhparser_zh (
    PARSER = public.zhparser );

ALTER TEXT SEARCH CONFIGURATION public.zhparser_zh
    ADD MAPPING FOR a WITH simple;
...
ALTER TEXT SEARCH CONFIGURATION public.zhparser_zh OWNER TO zhouch;
...
--
-- Name: agent_messages; Type: TABLE; Schema: public; Owner: zhouch
--
...
CREATE TABLE public.agent_messages (
    ...
    msg_type public.messagetype DEFAULT 'TEXT'::public.messagetype NOT NULL,
    sources jsonb,
    tool_calls jsonb,
    seq integer DEFAULT 0 NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    status public.messagestatus DEFAULT 'normal'::public.messagestatus NOT NULL,
    pending_data jsonb
);


ALTER TABLE public.agent_messages OWNER TO zhouch;

--
-- Name: COLUMN agent_messages.status; Type: COMMENT; Schema: public; Owner: zhouch
--

COMMENT ON COLUMN public.agent_messages.status IS '消息状态: normal=普通 | apply_pending=申请待确认';


--
-- Name: COLUMN agent_messages.pending_data; Type: COMMENT; Schema: public; Owner: zhouch
--

COMMENT ON COLUMN public.agent_messages.pending_data IS 'HITL 待确认数据（JSON）';


--
-- Name: agent_messages_id_seq; Type: SEQUENCE; Schema: public; Owner: zhouch
--
...
ALTER SEQUENCE public.agent_messages_id_seq OWNER TO zhouch;

--
-- Name: agent_messages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zhouch
--
...
--
-- Name: agent_session_snapshots; Type: TABLE; Schema: public; Owner: zhouch
--
...
CREATE TABLE public.agent_session_snapshots (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    last_summary_end_seq integer DEFAULT 0 NOT NULL,
    recent_summary_count integer DEFAULT 0 NOT NULL,
    last_summary_at timestamp with time zone,
    total_summary_count integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.agent_session_snapshots OWNER TO zhouch;

--
-- Name: agent_session_snapshots_id_seq; Type: SEQUENCE; Schema: public; Owner: zhouch
--

CREATE SEQUENCE public.agent_session_snapshots_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.agent_session_snapshots_id_seq OWNER TO zhouch;

--
-- Name: agent_session_snapshots_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zhouch
--

ALTER SEQUENCE public.agent_session_snapshots_id_seq OWNED BY public.agent_session_snapshots.id;


--
-- Name: agent_session_summaries; Type: TABLE; Schema: public; Owner: zhouch
--

CREATE TABLE public.agent_session_summaries (
    id integer NOT NULL,
    session_id integer NOT NULL,
    summary text NOT NULL,
    start_seq integer DEFAULT 0 NOT NULL,
    end_seq integer DEFAULT 0 NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
...
ALTER TABLE public.agent_session_summaries OWNER TO zhouch;

--
-- Name: agent_session_summaries_id_seq; Type: SEQUENCE; Schema: public; Owner: zhouch
--

CREATE SEQUENCE public.agent_session_summaries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.agent_session_summaries_id_seq OWNER TO zhouch;

--
-- Name: agent_session_summaries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zhouch
--

ALTER SEQUENCE public.agent_session_summaries_id_seq OWNED BY public.agent_session_summaries.id;
...
CREATE TABLE public.agent_sessions (
    ...
    title character varying(200) DEFAULT '新会话'::character varying NOT NULL,
...
CREATE TABLE public.applications (
    ...
    rule_info jsonb DEFAULT '{}'::jsonb NOT NULL
);
...
--
-- Name: COLUMN applications.rule_info; Type: COMMENT; Schema: public; Owner: zhouch
--

COMMENT ON COLUMN public.applications.rule_info IS '申请提交时的 rule 快照（v7）：{rule.name: attribute.name}。学生提交时按 (template_id, attribute) 反查 rule，扁平化为单层结构。TRANSFORM 类型由 apply_score / gain_score 承载分数，rule_info 不重复存储。';
...
CREATE TABLE public.embeddings (
    id integer DEFAULT nextval('public.embeddings_id_seq'::regclass) NOT NULL,
    ...
    content_tsv tsvector GENERATED ALWAYS AS (to_tsvector('public.chinese_zh'::regconfig, (((COALESCE(title, ''::character varying))::text || ' '::text) || COALESCE(content, ''::text)))) STORED
);
...
--
-- Name: COLUMN users.department; Type: COMMENT; Schema: public; Owner: zhouch
--

COMMENT ON COLUMN public.users.department IS '所在系（学生自填，导出 daily.md 用）';


--
-- Name: COLUMN users.student_id; Type: COMMENT; Schema: public; Owner: zhouch
--

COMMENT ON COLUMN public.users.student_id IS '学号（学生自填；为空时 fallback 到 extract_student_id(username)）';


--
-- Name: COLUMN users.gender; Type: COMMENT; Schema: public; Owner: zhouch
--

COMMENT ON COLUMN public.users.gender IS '性别：M（男）/ F（女）/ OTHER（其他）';


--
-- Name: COLUMN users.id_card_number; Type: COMMENT; Schema: public; Owner: zhouch
--

COMMENT ON COLUMN public.users.id_card_number IS '身份证号（敏感信息，UI 不展示）';
...
--
-- Name: agent_messages id; Type: DEFAULT; Schema: public; Owner: zhouch
--
...
--
-- Name: agent_session_snapshots id; Type: DEFAULT; Schema: public; Owner: zhouch
--

ALTER TABLE ONLY public.agent_session_snapshots ALTER COLUMN id SET DEFAULT nextval('public.agent_session_snapshots_id_seq'::regclass);


--
-- Name: agent_session_summaries id; Type: DEFAULT; Schema: public; Owner: zhouch
--

ALTER TABLE ONLY public.agent_session_summaries ALTER COLUMN id SET DEFAULT nextval('public.agent_session_summaries_id_seq'::regclass);
...
--
-- Name: agent_messages agent_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: zhouch
--
...
--
-- Name: agent_session_snapshots agent_session_snapshots_pkey; Type: CONSTRAINT; Schema: public; Owner: zhouch
--
...
--
-- Name: agent_session_snapshots agent_session_snapshots_session_id_key; Type: CONSTRAINT; Schema: public; Owner: zhouch
--

ALTER TABLE ONLY public.agent_session_snapshots
    ADD CONSTRAINT agent_session_snapshots_session_id_key UNIQUE (session_id);


--
-- Name: agent_session_summaries agent_session_summaries_pkey; Type: CONSTRAINT; Schema: public; Owner: zhouch
--

ALTER TABLE ONLY public.agent_session_summaries
    ADD CONSTRAINT agent_session_summaries_pkey PRIMARY KEY (id);
...
--
-- Name: idx_agent_messages_session_id; Type: INDEX; Schema: public; Owner: zhouch
--
...
--
-- Name: idx_agent_messages_session_status; Type: INDEX; Schema: public; Owner: zhouch
--

CREATE INDEX idx_agent_messages_session_status ON public.agent_messages USING btree (session_id, status) WHERE (status <> 'normal'::public.messagestatus);


--
-- Name: idx_agent_messages_status; Type: INDEX; Schema: public; Owner: zhouch
--

CREATE INDEX idx_agent_messages_status ON public.agent_messages USING btree (status) WHERE (status <> 'normal'::public.messagestatus);


--
-- Name: idx_agent_session_snapshots_session_id; Type: INDEX; Schema: public; Owner: zhouch
--

CREATE INDEX idx_agent_session_snapshots_session_id ON public.agent_session_snapshots USING btree (session_id);


--
-- Name: idx_agent_session_summaries_archived; Type: INDEX; Schema: public; Owner: zhouch
--

CREATE INDEX idx_agent_session_summaries_archived ON public.agent_session_summaries USING btree (session_id, is_archived, end_seq);


--
-- Name: idx_agent_session_summaries_session_id; Type: INDEX; Schema: public; Owner: zhouch
--

CREATE INDEX idx_agent_session_summaries_session_id ON public.agent_session_summaries USING btree (session_id);


--
-- Name: idx_agent_sessions_user_id; Type: INDEX; Schema: public; Owner: zhouch
--
...
--
-- Name: idx_applications_rule_info_gin; Type: INDEX; Schema: public; Owner: zhouch
--

CREATE INDEX idx_applications_rule_info_gin ON public.applications USING gin (rule_info);
...
--
-- Name: idx_users_student_id; Type: INDEX; Schema: public; Owner: zhouch
--
...
--
-- Name: ix_embeddings_source_id; Type: INDEX; Schema: public; Owner: zhouch
--

CREATE INDEX ix_embeddings_source_id ON public.embeddings USING btree (source_id);
...
--
-- Name: agent_messages agent_messages_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zhouch
--
...
--
-- Name: agent_session_snapshots agent_session_snapshots_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zhouch
--

ALTER TABLE ONLY public.agent_session_snapshots
    ADD CONSTRAINT agent_session_snapshots_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.agent_sessions(id) ON DELETE CASCADE;


--
-- Name: agent_session_summaries agent_session_summaries_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zhouch
--

ALTER TABLE ONLY public.agent_session_summaries
    ADD CONSTRAINT agent_session_summaries_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.agent_sessions(id) ON DELETE CASCADE;


--
-- Name: agent_sessions agent_sessions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: zhouch
--
...
\unrestrict B3u93atvegpSZTIOkm1FTtTlMC2VztsWG2qpmkJRvwKLNx4bC51GrTdIqX26crY
