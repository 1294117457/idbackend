...
--
-- Name: policy_documents; Type: TABLE; Schema: public; Owner: zhouch
--
...
ALTER TABLE public.policy_documents OWNER TO zhouch;

--
-- Name: policy_documents_id_seq; Type: SEQUENCE; Schema: public; Owner: zhouch
--
...
ALTER SEQUENCE public.policy_documents_id_seq OWNER TO zhouch;

--
-- Name: policy_documents_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: zhouch
--
...
--
-- Name: policy_documents id; Type: DEFAULT; Schema: public; Owner: zhouch
--
...
--
-- Name: policy_documents policy_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: zhouch
--
